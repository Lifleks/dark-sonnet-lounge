	...
	theme: {
		...
		extend: {
			colors: {
				...
				gothic: {
					glow: 'hsl(var(--gothic-glow))',
					shadow: 'hsl(var(--gothic-shadow))',
					accent: 'hsl(var(--gothic-accent))',
					highlight: 'hsl(var(--gothic-highlight))'
				}
			},
			backgroundImage: {
			...
			transitionTimingFunction: {
				'gothic': 'cubic-bezier(0.23, 1, 0.32, 1)'
			},
			fontFamily: {
				'gothic': ['Inter', 'system-ui', 'sans-serif']
			},
			borderRadius: {
				lg: 'var(--radius)',
